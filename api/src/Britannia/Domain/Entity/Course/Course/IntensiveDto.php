...
class IntensiveDto extends CourseDto implements AssessmentDtoInterface
{

    public ?DatedPayment $singlePayment = null;

    public ?DatedPayment $firstPayment = null;
    
    public ?DatedPayment $secondPayment = null;
