...
class JobDiscountType extends AbstractCompoundType
{
    ...
    {
        $this->jobStatusDiscountList = $setting->jobStatusDiscount();
    }
    ...
    public function customForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if ($options['enable_default_data']) {
            $courseDiscount = $this->jobStatusDiscountList->getByJobStatus($status);
